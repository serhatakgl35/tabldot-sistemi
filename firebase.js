...
async function collectionDataSafe(name) {
  try {
    ...
    if (isPermissionDenied(error)) {
      ...
      console.warn(`Firestore koleksiyonu bu kullanıcı için kapalı: ${name}. Aşçı ekranında izin/yoklama görünmüyorsa V9.3.8 firestore.rules dosyasını Firebase Console'da yayımlayın.`);
      return [];
    }
    throw error;
  }
